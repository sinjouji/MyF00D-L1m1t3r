...
起動時のページ制御
*/
var shoppingStartToggle =
  document.getElementById('shoppingStartToggle');

if (shoppingStartToggle) {
  shoppingStartToggle.checked =
    localStorage.getItem('foodStartPage') === 'shopping.html';
